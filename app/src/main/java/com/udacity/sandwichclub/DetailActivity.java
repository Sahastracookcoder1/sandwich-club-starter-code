...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        TextView placeOfOriginTv = findViewById(R.id.place_origin);
        TextView mainNameTv  = findViewById(R.id.origin_tv);

        mainNameTv.setText(sandwich.getMainName());
        placeOfOriginTv.setText(sandwich.getPlaceOfOrigin());
        descriptionTv.setText(sandwich.getDescription());
        //use of textUtils to join the different ingredients string and display them all.
